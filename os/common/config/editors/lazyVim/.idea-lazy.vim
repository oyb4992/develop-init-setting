...
"  vim-paragraph-motion, anyobject, dial, indentwise, abolish
"
" 추가 액션 의존성
...
" ------------------------------------------------------------
" Abolish case conversion: <leader>r (Visual)
" ------------------------------------------------------------
let g:WhichKeyDesc_rs_visual = "<leader>rs snake_case"
let g:WhichKeyDesc_rm_visual = "<leader>rm PascalCase"
let g:WhichKeyDesc_rc_visual = "<leader>rc camelCase"
let g:WhichKeyDesc_ru_visual = "<leader>ru UPPER_SNAKE_CASE"
let g:WhichKeyDesc_rk_visual = "<leader>rk kebab-case"
let g:WhichKeyDesc_r_dot_visual = "<leader>r. dot.case"
let g:WhichKeyDesc_r_space_visual = "<leader>r<Space> space case"
let g:WhichKeyDesc_rt_visual = "<leader>rt Title Case"
